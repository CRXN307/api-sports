...
/**
 * Pre-configured HTTP client passed to each sport module.
 * Created once by `ApiSports()` and shared across all sport namespaces.
 */
...
/**
 * Creates a pre-configured HTTP client that attaches the API key to every
 * request and normalises all error shapes into `ApiSportsError`.
 */
