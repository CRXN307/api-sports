...
| `code`    | string | false    | [2..6] characters, FR, GB-ENG, IT... | The Alpha code of the country |
| `search`  | string | false    | = 3 characters                       | The name of the country       |
...
> Examples available in Request samples.
...
| Parameter  | Type    | Required | Constraints                          | Description                                    |
|------------|---------|----------|--------------------------------------|------------------------------------------------|
| `id`       | integer | false    |                                      | The id of the league                           |
| `name`     | string  | false    |                                      | The name of the league                         |
| `country`  | string  | false    |                                      | The country name of the league                 |
| `code`     | string  | false    | [2..6] characters, FR, GB-ENG, IT... | The Alpha code of the country                  |
| `season`   | integer | false    | = 4 characters, YYYY                 | The season of the league                       |
| `team`     | integer | false    |                                      | The id of the team                             |
| `type`     | string  | false    | Enum: "league" "cup"                 | The type of the league                         |
| `current`  | boolean | false    |                                      | The state of the league                        |
| `search`   | string  | false    | >= 3 characters                      | The name or the country of the league          |
| `last`     | integer | false    | <= 2 characters                      | The X last leagues/cups added in the API       |
...
| Parameter  | Type    | Required | Constraints          | Description                              |
|------------|---------|----------|----------------------|------------------------------------------|
| `id`       | integer | false    |                      | The id of the team                       |
| `name`     | string  | false    |                      | The name of the team                     |
| `league`   | integer | false    |                      | The id of the league                     |
| `season`   | integer | false    | = 4 characters, YYYY | The season of the league                 |
| `country`  | string  | false    |                      | The country name of the team             |
| `code`     | string  | false    | = 3 characters       | The code of the team                     |
| `venue`    | integer | false    |                      | The id of the venue                      |
| `search`   | string  | false    | >= 3 characters      | The name or the country name of the team |
...
| Parameter  | Type    | Required | Constraints          | Description              |
|------------|---------|----------|----------------------|--------------------------|
| `league`   | integer | true     |                      | The id of the league     |
| `season`   | integer | true     | = 4 characters, YYYY | The season of the league |
| `team`     | integer | true     |                      | The id of the team       |
| `date`     | string  | false    | YYYY-MM-DD           | The limit date           |
...
```json
{
  ...
  "errors": {
    "time": "2019-11-26T00:00:00+00:00",
    "bug": "This is on our side, please report us this bug on https://dashboard.api-football.com",
    "report": "teams/statistics?league=39&team=33&season=2019"
  },
  "results": 0,
  "paging": {
    "current": 1,
...
| Parameter  | Type    | Required | Constraints     | Description                          |
|------------|---------|----------|-----------------|--------------------------------------|
| `id`       | integer | false    |                 | The id of the venue                  |
| `name`     | string  | false    |                 | The name of the venue                |
| `city`     | string  | false    |                 | The city of the venue                |
| `country`  | string  | false    |                 | The country name of the venue        |
| `search`   | string  | false    | >= 3 characters | The name, city or the country of the venue |
...
| `league`    | integer | true     |                      | The id of the league                       |
| `season`    | integer | true     | = 4 characters, YYYY | The season of the league                   |
| `current`   | boolean | false    |                      | The current round only                     |
| `dates`     | boolean | false    | Default: false       | Add the dates of each round in the response|
| `timezone`  | string  | false    |                      | A valid timezone from the endpoint         |
...
| Parameter  | Type    | Required | Constraints                  | Description                        |
|------------|---------|----------|------------------------------|------------------------------------|
| `id`       | integer | false    | Value: "id"                  | The id of the fixture              |
| `ids`      | string  | false    | Maximum of 20 fixtures ids, Value: "id-id-id" | One or more fixture ids |
| `live`     | string  | false    | Enum: "all" "id-id"          | All or several leagues ids         |
| `date`     | string  | false    | YYYY-MM-DD                   | A valid date                       |
| `league`   | integer | false    |                              | The id of the league               |
| `season`   | integer | false    | = 4 characters, YYYY         | The season of the league           |
| `team`     | integer | false    |                              | The id of the team                 |
| `last`     | integer | false    | <= 2 characters              | For the X last fixtures            |
| `next`     | integer | false    | <= 2 characters              | For the X next fixtures            |
| `from`     | string  | false    | YYYY-MM-DD                   | A valid date                       |
| `to`       | string  | false    | YYYY-MM-DD                   | A valid date                       |
| `round`    | string  | false    |                              | The round of the fixture           |
| `status`   | string  | false    | Enum: "NS" "NS-PST-FT"       | One or more fixture status short   |
| `venue`    | integer | false    |                              | The venue id of the fixture        |
| `timezone` | string  | false    |                              | A valid timezone from the endpoint |
...
| Parameter  | Type    | Required | Constraints          | Description                        |
|------------|---------|----------|----------------------|------------------------------------|
| `h2h`      | string  | true     | ID-ID                | The ids of the teams               |
| `date`     | string  | false    | YYYY-MM-DD           | A valid date                       |
| `league`   | integer | false    |                      | The id of the league               |
| `season`   | integer | false    | = 4 characters, YYYY | The season of the league           |
| `last`     | integer | false    |                      | For the X last fixtures            |
| `next`     | integer | false    |                      | For the X next fixtures            |
| `from`     | string  | false    | YYYY-MM-DD           | A valid date                       |
| `to`       | string  | false    | YYYY-MM-DD           | A valid date                       |
| `status`   | string  | false    | Enum: "NS" "NS-PST-FT" | One or more fixture status short |
| `venue`    | integer | false    |                      | The venue id of the fixture        |
...
| Parameter  | Type    | Required | Constraints    | Description                                |
|------------|---------|----------|----------------|--------------------------------------------|
| `fixture`  | integer | true     |                | The id of the fixture                      |
| `team`     | integer | false    |                | The id of the team                         |
| `type`     | string  | false    |                | The type of statistics                     |
| `half`     | boolean | false    | Default: false | Add the halftime statistics in the response|
...
| `fixture`  | integer | true     |             | The id of the fixture |
| `team`     | integer | false    |             | The id of the team    |
| `player`   | integer | false    |             | The id of the player  |
| `type`     | string  | false    |             | The type              |
...
|-------------|---------|----------|-----------------------------------------|--------------------------------------------------------------------|
| `league`    | integer | false    |                                         | The id of the league                                               |
| `season`    | integer | false    | = 4 characters, YYYY                   | The season of the league, required with league, team and player parameters |
| `fixture`   | integer | false    |                                         | The id of the fixture                                              |
| `team`      | integer | false    |                                         | The id of the team                                                 |
| `player`    | integer | false    |                                         | The id of the player                                               |
| `date`      | string  | false    | YYYY-MM-DD                              | A valid date                                                       |
| `ids`       | string  | false    | Maximum of 20 fixtures ids, Value: "id-id-id" | One or more fixture ids                                      |
...
| Parameter | Type    | Required | Constraints     | Description           |
|-----------|---------|----------|-----------------|-----------------------|
| `id`      | integer | false    |                 | The id of the coach   |
| `team`    | integer | false    |                 | The id of the team    |
| `search`  | string  | false    | >= 3 characters | The name of the coach |
...
|-----------|---------|----------|-----------------|----------------------------|
| `player`  | integer | false    |                 | The id of the player       |
| `search`  | string  | false    | >= 3 characters | The lastname of the player |
| `page`    | integer | false    | Default: 1      | Use for the pagination     |
...
| Parameter | Type    | Required | Constraints                                              | Description              |
|-----------|---------|----------|----------------------------------------------------------|--------------------------|
| `id`      | integer | false    |                                                          | The id of the player     |
| `team`    | integer | false    |                                                          | The id of the team       |
| `league`  | integer | false    |                                                          | The id of the league     |
| `season`  | integer | false    | = 4 characters, YYYY, Requires the fields Id, League or Team | The season of the league |
| `search`  | string  | false    | >= 4 characters, Requires the fields League or Team      | The name of the player   |
| `page`    | integer | false    | Default: 1                                               | Use for the pagination   |
...
| Parameter | Type    | Required | Constraints | Description          |
|-----------|---------|----------|-------------|----------------------|
| `player`  | integer | true     |             | The id of the player |
...
|-----------|---------|----------|------------------------------------------------|------------------------|
| `player`  | integer | false    |                                                | The id of the player   |
| `players` | string  | false    | Maximum of 20 players ids, Value: "id-id-id"   | One or more players ids|
| `coach`   | integer | false    |                                                | The id of the coach    |
| `coachs`  | string  | false    | Maximum of 20 coachs ids, Value: "id-id-id"    | One or more coachs ids |
...
| `fixture`  | integer | false    |             | The id of the fixture |
| `league`   | integer | false    |             | The id of the league  |
| `bet`      | integer | false    |             | The id of the bet     |
...
| Parameter | Type   | Required | Constraints    | Description          |
|-----------|--------|----------|----------------|----------------------|
| `id`      | string | false    |                | The id of the bet name |
| `search`  | string | false    | = 3 characters | The name of the bet  |
...
| `timezone`  | string  | false    |                      | A valid timezone from the endpoint |
| `page`      | integer | false    | Default: 1           | Use for the pagination             |
| `bookmaker` | integer | false    |                      | The id of the bookmaker            |
| `bet`       | integer | false    |                      | The id of the bet                  |
...
| Parameter | Type    | Required | Constraints    | Description             |
|-----------|---------|----------|----------------|-------------------------|
| `id`      | integer | false    |                | The id of the bookmaker |
| `search`  | string  | false    | = 3 characters | The name of the bookmaker |
